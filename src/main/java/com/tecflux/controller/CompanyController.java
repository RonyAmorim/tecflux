...
import com.tecflux.dto.company.CreateCompanyWithDepartmentAndUserRequestDTO;
...
public class CompanyController {
    ...
    @PostMapping("/create-with-department-user")
    public ResponseEntity<CompanyResponseDTO> createCompanyWithDepartmentAndUser(@RequestBody CreateCompanyWithDepartmentAndUserRequestDTO requestDTO) {
        try {
            CompanyResponseDTO companyResponse = companyService.createCompany(requestDTO);
